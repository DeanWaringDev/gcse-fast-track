...
import lessonsData from '@/public/data/maths/lessons.json';
...
export default function LessonPage() {
  ...
  async function checkAccess() {
    ...
    if (authError || !user) {
      router.push(`/login?redirect=/courses/maths/lessons/${slug}`);
      return;
    }
      ...
      <div className="bg-linear-to-r from-blue-600 to-blue-800 text-white py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-2">
            <span className="text-blue-200 font-semibold">#{lesson.number}</span>
