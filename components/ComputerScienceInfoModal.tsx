/**
 * Computer Science Course Info Modal
 * 
 * Displays a slideshow presentation of GCSE Computer Science course information
...
interface ComputerScienceInfoModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function ComputerScienceInfoModal({ isOpen, onClose }: ComputerScienceInfoModalProps) {
      ...
      content: (
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-6">
            Master Computer Science with our structured crash course
          </p>
        ...
        <div>
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="bg-linear-to-br from-blue-50 to-cyan-50 p-6 rounded-xl border-2 border-blue-100">
              ...
              <p className="text-gray-600 mb-3">Covers all essential GCSE Computer Science topics required for grades 1-5</p>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>Data Representation (7 lessons)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>Computer Systems (5 lessons)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>Algorithms (8 lessons)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>Programming (24 lessons)</span>
                </li>
              </ul>
            </div>
            <div className="bg-linear-to-br from-purple-50 to-pink-50 p-6 rounded-xl border-2 border-purple-100">
              ...
              <p className="text-gray-600 mb-3">Advanced topics targeting grades 6-9</p>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">•</span>
                  <span>Merge Sort & Advanced Algorithms</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">•</span>
                  <span>Recursion & OOP</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">•</span>
                  <span>Data Structures (Stacks, Queues, Trees)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">•</span>
                  <span>Complex Boolean Logic Circuits</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4 text-center">
            <p className="text-sm text-gray-700">
              <strong className="text-yellow-800">All Exam Boards:</strong> AQA, OCR, Edexcel - Comprehensive coverage for all specifications
            </p>
          </div>
        </div>
      ),
        ...
        <div className="grid md:grid-cols-2 gap-4 max-h-[500px] overflow-y-auto pr-2">
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-blue-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">💾</span> Data Representation (7 lessons)
            </h4>
            <p className="text-sm text-gray-600">Binary, Hexadecimal, ASCII/Unicode, Images, Sound, Compression</p>
          ...
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-purple-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🖥️</span> Computer Systems (5 lessons)
            </h4>
            <p className="text-sm text-gray-600">CPU, Fetch-Execute Cycle, RAM/ROM, Storage</p>
            <div className="mt-2 text-xs text-green-600 font-semibold">5 lessons free</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-green-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🔄</span> Algorithms (8 lessons)
            </h4>
            <p className="text-sm text-gray-600">Flowcharts, Pseudocode, Searching, Sorting</p>
            <div className="mt-2 text-xs text-green-600 font-semibold">7 lessons free</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-cyan-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">💻</span> Programming (24 lessons)
            </h4>
            <p className="text-sm text-gray-600">Python Basics, Variables, Selection, Iteration, Lists, Functions, File Handling, Projects</p>
          ...
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-orange-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🗄️</span> Databases (6 lessons)
            </h4>
            <p className="text-sm text-gray-600">Database Concepts, SQL SELECT/INSERT/UPDATE/DELETE, JOINs</p>
          ...
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-indigo-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🌐</span> Networks (7 lessons)
            </h4>
            <p className="text-sm text-gray-600">LAN/WAN, Hardware, Topologies, Protocols, IP, Internet</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-red-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🔒</span> Cyber Security (3 lessons)
            </h4>
            <p className="text-sm text-gray-600">Threats, Prevention, Encryption</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-pink-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">⚙️</span> Software (4 lessons)
            </h4>
            <p className="text-sm text-gray-600">Operating Systems, Memory Management, Utilities</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-yellow-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">⚖️</span> Ethics and Law (4 lessons)
            </h4>
            <p className="text-sm text-gray-600">GDPR, Computer Misuse Act, Copyright, Environmental Impact</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-lime-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🔌</span> Boolean Logic (3 lessons)
            </h4>
            <p className="text-sm text-gray-600">Logic Gates, Truth Tables, Circuits</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-teal-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">📚</span> Data Structures (3 lessons)
            </h4>
            <p className="text-sm text-gray-600">Stacks, Queues, Binary Trees</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-violet-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">🚀</span> Emerging Technologies (3 lessons)
            </h4>
            <p className="text-sm text-gray-600">AI/ML, Robotics, Cloud Computing</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-gray-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">📖</span> Revision (14 lessons)
            </h4>
            <p className="text-sm text-gray-600">Topic-specific revision sessions</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
          <div className="bg-white p-5 rounded-xl shadow-md border-l-4 border-gray-500">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span className="text-2xl">📝</span> Exam Preparation (9 lessons)
            </h4>
            <p className="text-sm text-gray-600">Exam technique, Mock exams, Past papers</p>
            <div className="mt-2 text-xs text-gray-500 font-semibold">Premium only</div>
          </div>
        </div>
      ),
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4 bg-linear-to-r from-purple-50 to-purple-100 p-5 rounded-xl">
            ...
            <div>
              <h4 className="font-bold text-gray-800 mb-1">Learn Python Programming</h4>
              <p className="text-sm text-gray-600">Practical coding skills with Python - from basics to advanced algorithms and data structures.</p>
            </div>
          </div>
          <div className="flex items-start gap-4 bg-linear-to-r from-yellow-50 to-yellow-100 p-5 rounded-xl">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Complete the course in 24 weeks or go faster - full lifetime access to all content.</p>
            </div>
          </div>
        </div>
      ),
        ...
        <div className="text-center">
          ...
          <div className="bg-linear-to-br from-green-50 to-emerald-50 p-8 rounded-2xl max-w-md mx-auto mb-6 border-2 border-green-200">
            ...
            <EnrollButton
              ...
              variant="modal"
              className="w-full py-4 rounded-xl font-bold text-lg text-white bg-cyan-600 hover:bg-cyan-700 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            />
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="px-8 py-6 bg-gray-50 border-t flex items-center justify-between">
            ...
            {slides.map((_, index) => (
              <button
                ...
                className={`h-2.5 rounded-full transition-all ${
                  index === currentSlide ? 'w-8 bg-cyan-600' : 'w-2.5 bg-gray-300'
                }`}
          ...
          <button
            ...
            className="px-6 py-3 rounded-lg font-semibold text-white bg-cyan-600 hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
          >
            Next
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
